...
map <- matrix(as.numeric(mapvalues), byrow = TRUE, nrow = 10, ncol = 10)           
colnames(map) <- paste0(1:10)                             
rownames(map) <- paste0(1:10) 
pheatmap(map, cluster_rows = FALSE, cluster_cols = FALSE, border_color = FALSE, legend = TRUE, labels_row = "", labels_col = "", main = "Probe distribution for lab array (10x10)")
